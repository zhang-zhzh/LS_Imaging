...
handles.ContinuslyMove.Value=P.ContinuslyMove;
handles.Planning.Value=P.Planning;
handles.PlanningMag.Value=P.PlanningMag;
handles.ImagingMag.Value=P.ImagingMag;
handles.SignalThreshold.String=P.SignalThreshold;
handles.SignalRatio.String=P.SignalRatio;
handles.OverlapImaging.String=P.OverlapImaging;
handles.OverlapPlanning.String=P.OverlapPlanning;
handles.LightSide.Value=P.LightSide;
handles.LightColor.Value=P.LightColor;
handles.PlanningLeftETLVoltage.String=P.PlanningLeftETLVoltage;
handles.PlanningRightETLVoltage.String=P.PlanningRightETLVoltage;
handles.MoveToLocation.String=P.MoveToLocation;
handles.TellLocation.String=P.TellLocation;
handles.CheckPlanning.Value=P.CheckPlanning;
