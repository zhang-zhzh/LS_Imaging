...
% Last Modified by GUIDE v2.5 10-Jun-2019 11:17:52
...
% Hint: get(hObject,'Value') returns toggle state of SetCenter
 ...
 handles.my.CurrentLocation1=[0 0];
 handles.my.CurrentLocationPlanning=[0 0];
 guidata(hObject,handles);
...
OverLapLowMag=OverlapLowImaging/100;
...
InputVolume=ones(CurrentStitchedImagePixelSize(1),CurrentStitchedImagePixelSize(2));
...
function MoveToPlanning_Callback(hObject, eventdata, handles)
% hObject    handle to MoveToPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MoveToPlanning as text
%        str2double(get(hObject,'String')) returns contents of MoveToPlanning as a double

MoveToLocation=eval(handles.MoveToPlanning.String);
CurrentLocation= handles.my.CurrentLocationPlanning;
classObj=handles.my.classObj;
GX=MoveToLocation(1);
GY=MoveToLocation(2);
MagLow=str2num(handles.PlanningMag.String{handles.PlanningMag.Value}(1:end-1));
...
ImagingCenterLocation=CurrentStitchedImageRealCenter;
...
if all(CurrentLocation==0)
    ...
    CurrentImagingCenterLocation=[GX*2048-(GX-1)*2048*OverLapLowMag,GY*2048-(GY-1)*2048*OverLapLowMag]*ResolutionProgramme;
end

if all(MoveToLocation==0)
    MoveToImagingCenterLocation=ImagingCenterLocation;
else
    MoveToImagingCenterLocation=[MoveToLocation(1)*2048-(MoveToLocation(1)-1)*2048*OverLapLowMag,MoveToLocation(2)*2048-(MoveToLocation(2)-1)*2048*OverLapLowMag]*ResolutionProgramme;
end
...
MoveToADestination(CurrentImagingCenterLocation,MoveToImagingCenterLocation,classObj,StepUnit,Normalspeed,Acceleration,TimeConstant);
handles.my.CurrentLocationPlanning=MoveToLocation;
guidata(hObject,handles);
...
% --- Executes during object creation, after setting all properties.
function MoveToPlanning_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MoveToPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Hint: get(hObject,'Value') returns toggle state of SetZero
classObj=handles.my.classObj;
...
handles.my.OriginalCenterLocation=CurrentPosition;
handles.SetZero.Value=0;
...
% Hint: get(hObject,'Value') returns toggle state of MoveZero
classObj=handles.my.classObj;
CurrentPosition=handles.my.OriginalCenterLocation;
MoveToZerosF(classObj,CurrentPosition);
handles.MoveZero.Value=0;




% --- Executes on selection change in ImagingMag2.
function ImagingMag2_Callback(hObject, eventdata, handles)
% hObject    handle to ImagingMag2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns ImagingMag2 contents as cell array
%        contents{get(hObject,'Value')} returns selected item from ImagingMag2


% --- Executes during object creation, after setting all properties.
function ImagingMag2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ImagingMag2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function SignalThreshold2_Callback(hObject, eventdata, handles)
% hObject    handle to SignalThreshold2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of SignalThreshold2 as text
%        str2double(get(hObject,'String')) returns contents of SignalThreshold2 as a double


% --- Executes during object creation, after setting all properties.
function SignalThreshold2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SignalThreshold2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function SignalRatio2_Callback(hObject, eventdata, handles)
% hObject    handle to SignalRatio2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of SignalRatio2 as text
%        str2double(get(hObject,'String')) returns contents of SignalRatio2 as a double


% --- Executes during object creation, after setting all properties.
function SignalRatio2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to SignalRatio2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function OverlapImaging2_Callback(hObject, eventdata, handles)
% hObject    handle to OverlapImaging2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of OverlapImaging2 as text
%        str2double(get(hObject,'String')) returns contents of OverlapImaging2 as a double


% --- Executes during object creation, after setting all properties.
function OverlapImaging2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to OverlapImaging2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ImagingLeftETLVoltage_Callback(hObject, eventdata, handles)
% hObject    handle to ImagingLeftETLVoltage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ImagingLeftETLVoltage as text
%        str2double(get(hObject,'String')) returns contents of ImagingLeftETLVoltage as a double


% --- Executes during object creation, after setting all properties.
function ImagingLeftETLVoltage_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ImagingLeftETLVoltage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ImagingRightETLVoltage_Callback(hObject, eventdata, handles)
% hObject    handle to ImagingRightETLVoltage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ImagingRightETLVoltage as text
%        str2double(get(hObject,'String')) returns contents of ImagingRightETLVoltage as a double


% --- Executes during object creation, after setting all properties.
function ImagingRightETLVoltage_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ImagingRightETLVoltage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ImagingLeftETLVoltage1_Callback(hObject, eventdata, handles)
% hObject    handle to ImagingLeftETLVoltage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ImagingLeftETLVoltage1 as text
%        str2double(get(hObject,'String')) returns contents of ImagingLeftETLVoltage1 as a double


% --- Executes during object creation, after setting all properties.
function ImagingLeftETLVoltage1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ImagingLeftETLVoltage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ImagingRightETLVoltage1_Callback(hObject, eventdata, handles)
% hObject    handle to ImagingRightETLVoltage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ImagingRightETLVoltage1 as text
%        str2double(get(hObject,'String')) returns contents of ImagingRightETLVoltage1 as a double


% --- Executes during object creation, after setting all properties.
function ImagingRightETLVoltage1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ImagingRightETLVoltage1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function MoveToLocation1_Callback(hObject, eventdata, handles)
% hObject    handle to MoveToLocation1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of MoveToLocation1 as text
%        str2double(get(hObject,'String')) returns contents of MoveToLocation1 as a double
ImagingMatrix=handles.my.ImagingMatrix1;
StartRowA=handles.my.StartRowA1;
EndRowA=handles.my.EndRowAV1;
StartColumnA=handles.my.StartColumnA1;
EndColumnA=handles.my.EndColumnAV1;
MoveToLocation=eval(handles.MoveToLocation1.String);
CurrentLocation=handles.my.CurrentLocation1;
ImagingCenterLocation=handles.ImagingCenterLocation1;
classObj=handles.my.classObj;
...
MoveToImagingCenterLocation=fix(MoveToImagingCenterLocation);
MoveToADestination(CurrentImagingCenterLocation,MoveToImagingCenterLocation,classObj,StepUnit,Normalspeed,Acceleration,TimeConstant);
handles.my.CurrentLocation1=MoveToLocation;
handles.MoveToLocation1.Value=0;
guidata(hObject,handles);



% --- Executes during object creation, after setting all properties.
function MoveToLocation1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to MoveToLocation1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in PriLoc1.
function PriLoc1_Callback(hObject, eventdata, handles)
% hObject    handle to PriLoc1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of PriLoc1
CurrentLocation=handles.my.CurrentLocation1;
display(['CurrentLocation: [', num2str(CurrentLocation(1)),',',num2str(CurrentLocation(2)),']'])
handles.PriLoc1.Value=0;
guidata(hObject,handles);


function LeftImagingPlanning_Callback(hObject, eventdata, handles)
% hObject    handle to LeftImagingPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of LeftImagingPlanning as text
%        str2double(get(hObject,'String')) returns contents of LeftImagingPlanning as a double


% --- Executes during object creation, after setting all properties.
function LeftImagingPlanning_CreateFcn(hObject, eventdata, handles)
% hObject    handle to LeftImagingPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function RightImagingPlanning_Callback(hObject, eventdata, handles)
% hObject    handle to RightImagingPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of RightImagingPlanning as text
%        str2double(get(hObject,'String')) returns contents of RightImagingPlanning as a double


% --- Executes during object creation, after setting all properties.
function RightImagingPlanning_CreateFcn(hObject, eventdata, handles)
% hObject    handle to RightImagingPlanning (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function LeftImaging1_Callback(hObject, eventdata, handles)
% hObject    handle to LeftImaging1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of LeftImaging1 as text
%        str2double(get(hObject,'String')) returns contents of LeftImaging1 as a double


% --- Executes during object creation, after setting all properties.
function LeftImaging1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to LeftImaging1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function RightImaging1_Callback(hObject, eventdata, handles)
% hObject    handle to RightImaging1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of RightImaging1 as text
%        str2double(get(hObject,'String')) returns contents of RightImaging1 as a double


% --- Executes during object creation, after setting all properties.
function RightImaging1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to RightImaging1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in VisPlanning1.
function VisPlanning1_Callback(hObject, eventdata, handles)
% hObject    handle to VisPlanning1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of VisPlanning1
MagLow=str2num(handles.PlanningMag.String{handles.PlanningMag.Value}(1:end-1)); % Planning Magnification
MagImaging=str2num(handles.ImagingMag2.String{handles.ImagingMag2.Value}(1:end-1)); % Imaging Magnification
OverlapLowImaging=str2num(handles.OverlapPlanning.String); % Overlap of the low magnification imaging 
OverlapHighImaging=str2num(handles.OverlapImaging2.String); % Overlap of the high magnifiation imaging
...
handles.my.ImagingMatrix1=ImagingMatrix;
handles.my.StartRowA1=StartRowA;
handles.my.EndRowA1=EndRowA;
handles.my.StartColumnA1=StartColumnA;
handles.my.EndColumnA1=EndColumnA;
handles.my.EndColumnAV1=EndColumnAV;
handles.my.EndRowAV1=EndRowAV;
handles.VisPlanning1.Value=0;
handles.ImagingCenterLocation1=ImagingCenterLocation;
guidata(hObject,handles);
