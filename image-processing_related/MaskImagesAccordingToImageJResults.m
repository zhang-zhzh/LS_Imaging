...
% fudgeFactor=0.5;
% DilateThick=20;
% RemovePixelSize=10000;
% Clearborder=0;
% MaskImages(folder,Cutoff,suffix,fudgeFactor,DilateThick,RemovePixelSize,Clearborder)


function MaskImagesAccordingToImageJResults(folder,OriginalFolder,Cutoff,suffix,fudgeFactor,DilateThick,RemovePixelSize,Clearborder)
...
%         end
        ...
        Im=loadTifFast([OriginalFolder Files{i} ]);
