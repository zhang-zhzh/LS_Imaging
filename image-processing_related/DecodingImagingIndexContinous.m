...
function [OriginalName,MovedName]=DecodingImagingIndexContinous(Folder,Tag,StartStack,StartImNum,ConfigureName,Move,StartPosition)
     ...
     while 1 
         ...
         for j=StartJ:StepJ:EndJ
            for i=StartI:StepI:EndI
                ...
                while 1
                    if RightOrWrong(SmallStackNow)==0 % 0 right
                        SmallStackNow=SmallStackNow+1;
                    else
                        break;
                    end
