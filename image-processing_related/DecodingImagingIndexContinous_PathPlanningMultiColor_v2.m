...
function [OriginalName,MovedName]=DecodingImagingIndexContinous_PathPlanningMultiColor_v2(Folder,Tag,StartStack,ConfigureName,Move,MaxProjectedImagingMatrix)
...
ImagesPerStack=50;  %P.Zcut/P.ZstepGratingRule; % step decided by the grating rule
        ...
        for i=ISeries
            ...
            for ColorS=1:ColorSize
                ...
                for im=StartIm:StepIm:EndIm
                    DecodingSnapPlanningMultiColor_v2;
                end
            end
        end
    end
