...
function [OriginalName,MovedName]=DecodingImagingIndexContinous_PathPlanningMultiColor(Folder,Tag,StartStack,ConfigureName,Move,MaxProjectedImagingMatrix)
        ...
        for i=ISeries
            ...
            for ColorS=1:ColorSize
                ...
                for im=StartIm:StepIm:EndIm
                    DecodingSnapPlanningMultiColor;
                end
            end
        end
    end
