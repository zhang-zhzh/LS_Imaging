...
function StitchingMaxProjection_v2_4x(Folder,StitchingColor,StitchingSide,Overlap,ComputeOverlap,ImagingRow)
...
for Color=StitchingColor
    ...
    %                            movefile(ChangedNameRight,FullNameRight);
                        ...
                        elseif k>RightImaging & k<=RightImaging+LeftImaging
                            FullNameLeft=[Folder,ImagePrefixLeft,e,'_',num2str(k),'_',num2str(j),'_MaxProjection3',Suffix];
                            ChangedNameLeft=[Folder,ImagePrefix,e,'_',num2str(k),'_',num2str(j),'_MaxProjection3',Suffix];
