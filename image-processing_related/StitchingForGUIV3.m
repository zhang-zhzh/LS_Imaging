...
function StitchingForGUIV3(Folder,StitchingColor,StitchingSide,Overlap,ComputeOverlap,StitchAccordingMaxProjection,StitchingConfiureFolder)
                ...
                if Side==3
                    for j=1:Column
                        for k=1:Row/2
                            ...
                            FullNameLeft=[Folder,ImagePrefixLeft,e,'_',num2str(SectionNow),'_',num2str(k+Row/2),'_',num2str(j),Suffix];
                            ChangedNameRight=[Folder,ImagePrefix,e,'_',num2str(SectionNow),'_',num2str(k),'_',num2str(j),Suffix];
                            ChangedNameLeft=[Folder,ImagePrefix,e,'_',num2str(SectionNow),'_',num2str(k+Row/2),'_',num2str(j),Suffix];
                            MaxProjectionNameLeft=[Folder,ImagePrefix,e,'_',num2str(k+Row/2),'_',num2str(j),'_MaxProjection3.tif'];
...
%                                movefile(ChangedNameRight,FullNameRight);
                ...
                if StitchAccordingMaxProjection==1
                    ...
                    ConfigureName=['TileConfiguration_Stack',num2str(e),'.txt'];
