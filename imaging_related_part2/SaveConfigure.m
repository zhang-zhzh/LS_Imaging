...
%% path planning
P.ContinuslyMove=handles.ContinuslyMove.Value;
P.Planning=handles.Planning.Value;
P.PlanningMag=handles.PlanningMag.Value;
P.ImagingMag=handles.ImagingMag.Value;
P.SignalThreshold=handles.SignalThreshold.String;
P.SignalRatio=handles.SignalRatio.String;
P.OverlapImaging=handles.OverlapImaging.String;
P.OverlapPlanning=handles.OverlapPlanning.String;
P.LightSide=handles.LightSide.Value;
P.LightColor=handles.LightColor.Value;
P.PlanningLeftETLVoltage=handles.PlanningLeftETLVoltage.String;
P.PlanningRightETLVoltage=handles.PlanningRightETLVoltage.String;
P.MoveToLocation=handles.MoveToLocation.String;
P.TellLocation=handles.TellLocation.String;
P.CheckPlanning=handles.CheckPlanning.Value;
