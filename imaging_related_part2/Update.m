...
%     FocusMoveLow2High=11196;
    ...
    % from 0.63 to 1.6  12188 5mm DippingCap
    FocusMoveHigh2Low=12188;
    FocusMoveLow2High=12188;
    
      % from 0.63 to 1.6  6.5mm Dipping Cap

%     FocusMoveHigh2Low=9754;
%     FocusMoveLow2High=9754;
...
%     FocusMoveHigh2Low1=1814;
%     FocusMoveLow2High1=1814;
...
%     LowPixel=[1024 1024];
   ...
   % for final imaging, 20190607
   HighPixel1=[1352 1099];
   LowPixel1=[1116 1047];
...
SaveFolder='D:\WholeBrainImagingData\20200716_tem\stack_1\';
%% 
MaxErrorPermitted=2;
