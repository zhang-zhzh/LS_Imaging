...
% LineInterval=50; %us
% Exposure=100; % ms % 
VoltageTrainLeftAll=eval(handles.PlanningLeftETLVoltage.String);
VoltageTrainRightAll=eval(handles.PlanningRightETLVoltage.String);

% VoltageTrainLeftAll=[2.8:-0.1:1.8;2.8:-0.1:1.8;1.8:0.1:2.8];
% VoltageTrainRightAll=[2.8:-0.1:1.8;2.8:-0.1:1.8;1.8:0.1:2.8];

% VoltageTrainLeft=1.6:0.1:2.9;% #
% VoltageTrainRight=2.8:-0.1:1.8;% #
VoltageTrainLeft=VoltageTrainLeftAll(ceil(M/GridY),:);
VoltageTrainRight=VoltageTrainRightAll(ceil(M/GridY),:);

%% link trigger channel 1
ProgramPulsePalParam(1, 13, 1); % 'LinkedToTriggerCH2';
ProgramPulsePalParam(2, 13, 1); 
ProgramPulsePalParam(3, 13, 1); 
